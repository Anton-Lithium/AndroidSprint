...
fun main() {
    ...
    if (userName == REGISTERED_USERNAME) {
        ...
        if (userPassword == REGISTERED_PASSWORD) {
            println("""Вздыхает... Ваши данные проверены, 
                и о, чудо, они верны... Пользователь \"$userName\", 
                вам разрешено входить...")
        } else {
            println("Пароль указан не верно!")
        }
    } else {
        println("Совпадений не найдено. Хотите зарегистрироваться?")
    }
}